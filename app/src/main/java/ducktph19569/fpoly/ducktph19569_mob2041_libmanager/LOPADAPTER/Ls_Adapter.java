        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (strSearch.isEmpty()){
                    ...
                    List<LoaiSach> listtv = new ArrayList<>();
                    for (LoaiSach loaiSach : mlistOld){
                        if (loaiSach.getTenLS().contains(strSearch)){
                            listtv.add(loaiSach);
                        }
                    }
                    sachList = listtv;
...
sachList=(List<LoaiSach>) results.values;
notifyDataSetChanged();
            }
        };
    }
