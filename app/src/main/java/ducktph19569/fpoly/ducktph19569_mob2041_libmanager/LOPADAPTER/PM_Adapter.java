...
//            Sach sach = sachDao.getId(phieuMuon.getMaSpm() + "");
            ...
            String gio = numberFormat.format(phieuMuon.getGiomuon());
            holder.tv_giomuon.setText("Giờ mượn:" + gio);
...
//                                phieuMuon.setMaNVpm(maNV);
    ...
    public class PhieuMuonhoder extends RecyclerView.ViewHolder {
        TextView tv_mapm, tv_matvpm, tv_maspm, tv_ngaymuon, tv_giamuon, tv_trasach,tv_giomuon;
        ...
        public PhieuMuonhoder(@NonNull @NotNull View itemView) {
            ...
            //
            tv_giomuon = itemView.findViewById(R.id.tv_giomuon);
            //
