package ducktph19569.fpoly.ducktph19569_mob2041_libmanager.LOPPRODUCT;
...
public class PhieuMuon {
    ...
    public int getGiomuon() {
        return giomuon;
    }

    public void setGiomuon(int giomuon) {
    ...
    public static final String COL_NAME_GIOMUON="giomuon_ph19569";

    public PhieuMuon() {
    }

    public PhieuMuon(int maPM, String maNVpm, int maTVpm, int maSpm, int tienthue, String ngaymuon, int trasach, int giomuon) {
        this.maPM = maPM;
        this.maNVpm = maNVpm;
        this.maTVpm = maTVpm;
        this.maSpm = maSpm;
